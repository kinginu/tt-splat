...
PARAMS_PER_GAUSSIAN = {"A": 14, "B": 14, "C0": 22, "C": 22, "SZ": 14, "RV": 14, "SM": 14, "BP": 14, "E": 14, "D": 14}
CANDIDATE_ARMS = ("A", "B", "C", "SZ", "RV", "SM", "BP", "E")   # real candidates (C0 = capacity control, D = ceiling)

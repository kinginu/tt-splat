...
ARMS = ("A", "B", "C0", "C", "SZ", "RV", "SM", "BP", "MO", "PW", "E", "D")
...
def render(model, cam, arm, k=4.0, blur_eps=0.3, near=0.2, sh_degree=0):
    ...
    if arm == "A":
        ...
        img = arms.blend_MO(w_geo, model.opacity_raw, depth, color, w_b, c_b)
    elif arm == "PW":
        img = arms.blend_PW(w_geo, model.opacity_raw, depth, model.pw_tau, color, w_b, c_b)
    elif arm == "E":
